...
public class mytest {
	...
	public static void main(String[] args) {
		...
		for (int kopo11_i = 0; kopo11_i < 20; kopo11_i++) { // 0 ~ 19까지 도는 반복문
...
class Elevater2 { // 클래스
	private int kopo11_limit_up_floor; // int 변수 선언
	private int kopo11_limit_down_floor; // int 변수 선언
	private int kopo11_floor; // int 변수 선언
	private String kopo11_help; // String 변수 선언
 
	Elevater2() { // 생성자
		kopo11_limit_up_floor = 10; // 초기값 10 대입
		kopo11_limit_down_floor = 1; // 초기값 1 대입
