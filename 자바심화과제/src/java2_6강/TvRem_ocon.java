...
public class TvRem_ocon {
	...
	String Voice; // String 전역변수 선언

	void VolUp() { // 볼륨 UP 메서드

		kopo11_vol++; // 1추가
		Voice = Voice.format("볼륨크기 : %d", kopo11_vol); // String 변수에 대입
		if (kopo11_vol == kopo11_vol_up) { // 두 조건이 같을 때
			Voice = "볼륨이 최대 5 입니다."; // String 변수에 대입
		}
	...
	void VolDn() { // 볼륨 DOWN 메서드
		...
		if (kopo11_vol == kopo11_vol_down) {// 두 조건이 같을 때
			Voice = "볼륨이 최소 0 입니다.";// String 변수에 대입
		}
	...
	void ChannelUp() { // 채널 UP 메서드
		kopo11_channel++; // 1추가
		Voice = Voice.format("채널번호 : %d", kopo11_channel); // String 변수에 대입
		if (kopo11_channel == kopo11_channel_up) { // 두 조건이 같을 때
			Voice = "채널이 최대 10 입니다."; // String 변수에 대입
		}
	...
	void ChannelDn() { // 채널 DOWN 메서드
		...
		if (kopo11_channel == kopo11_channel_down) { // 두 조건이 같을 때
			Voice = "채널이 최소 0 입니다."; // String 변수에 대입
		}
