...
//    int korSum, engSum, matSum, Sum, aveSum;
    ...
    public void score2(int kopo11_iPerson) { // 부모의 스코어 메서드 재정의
        ...
        for (int kopo11_i = 0; kopo11_i < kopo11_iPerson; kopo11_i++) { // 0 ~ kopo11_iPerson 까지 도는 반복문
            ...
            korSum2 += kopo11_kor[kopo11_i]; // 변수에 값 전달
            engSum2 += kopo11_eng[kopo11_i]; // 변수에 값 전달
            matSum2 += kopo11_mat[kopo11_i]; // 변수에 값 전달
            Sum2 += kopo11_sum[kopo11_i]; // 변수에 값 전달
            aveSum2 += (int) kopo11_ave[kopo11_i]; // 변수에 값 전달

            // 입력 받은 값 출력 개행
            System.out.printf("%03d%4s%-6s%6d%8d%9d%9d%9d\n", kopo11_i+1, "", kopo11_name[kopo11_i],
