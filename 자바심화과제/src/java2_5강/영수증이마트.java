...
public class 영수증이마트 {
	...
	public static void main(String[] args) {
		...
		// String 배열 값 30개 대입
		String[] kopo11_itemname = { "오뚜기 진비빔면 156g", "피코크 들깨미역국500","GAP 죽장사과 4-6입", "순 유기농 바나나(봉)","해피홈 SAFE365 핸드", "(G)LH원형유리화병 10", "상투과자E", "더블링 나일론 깡 롤", "해피홈 SAFE 핸드워시",
		...
		// int 배열 값 30개 대입
		int[] kopo11_num = { 2, 1, 1, 1, 2, 1, 1, 1, 2, 1, 1, 3, 1, 1, 2, 1, 1, 1, 2, 1, 2, 1, 1, 1, 1, 2, 1, 2, 1, 2 };
