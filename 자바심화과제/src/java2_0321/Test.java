...
public class Test {
	...
	public static void main(String[] args) {
		/*
		 * //////////////////////////////////////// // 범위를 주어서 찾기 // int kopo11_iVal; //
		 * int타입 변수 선언
		 * 
		 * for (int i = 0; i < 300; i++) { // 0 ~ 299 까지 도는 반복문
		 * 
		 * kopo11_iVal = 5 * i; // 5 * i 한 값을 변수에 대입
		 * 
		 * // iVal의 값이 0과 같거나 크고 '그리고' 10보다는 작으면 "일 = 값 출력" if(kopo11_iVal >= 0 &&
		 * kopo11_iVal < 10) System.out.printf("일 = %d\n", kopo11_iVal);
		 * 
		 * // iVal의 값이 10과 같거나 크고 '그리고' 100보다는 작으면 "십 = 값 출력" else if(kopo11_iVal >= 10
		 * && kopo11_iVal < 100) System.out.printf("십 = %d\n", kopo11_iVal);
		 * 
		 * // iVal의 값이 100과 같거나 크고 '그리고' 1000보다는 작으면 "백 = 값 출력" else if(kopo11_iVal >=
		 * 100 && kopo11_iVal < 1000) System.out.printf("백 = %d\n", kopo11_iVal);
		 * 
		 * // 조건에 없는 그 외의 값이 들어오면 "천 = 값 출력" else
...
//		
		...
		for (int i = 1; i < 13; i++) { // 1 ~ 12 까지 도는 반복문
