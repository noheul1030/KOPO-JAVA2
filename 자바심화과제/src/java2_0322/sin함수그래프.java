...
public class sin함수그래프 {
	...
	public static void main(String[] args) {
		...
		for (int kopo11_i = 0; kopo11_i < 360; kopo11_i++) { // 0 ~ 359 까지 도는 반복문
			// Math.sin() -> 한 각에 대한 사인값을 반환합니다.
			kopo11_fSin = Math.sin(kopo11_i * 3.101592/180); // fSin에 Math.sin(kopo11_i * 3.101592/180) 계산값 대입
		...
		for (int kopo11_i = 0; kopo11_i < 360; kopo11_i++) { // 0 ~ 359 까지 도는 반복문
			...
			for (int j = 0; j < kopo11_iSpace; j++) { System.out.printf(" "); // 0 ~ kopo11_iSpace 까지 도는 반복문
