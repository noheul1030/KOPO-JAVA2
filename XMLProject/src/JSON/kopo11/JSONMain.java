...
//		kopo11_datasArray.add(oneRec("나연", 209901, 90, 100, 95)); // kopo11_datasArray에 값 추가
		...
		kopo11_datasArray.add(oneRec("다현", 209907, 70, 75, 65)); // kopo11_datasArray에 값 추가
...
//					new FileOutputStream("C:\\Users\\노을\\Documents\\GitHub\\KOPO-JAVA2\\XMLProject\\jsontest.json"),"UTF-8"));
			
			// FileWriter로 "UTF-8"형식으로 작성 
